...
echo "INFO: Executing test and report generation script..."
bash admin/run_tests_and_report.sh
TEST_EXIT_CODE=$?
...
if [ $TEST_EXIT_CODE -ne 0 ]; then
    ...
    exit $TEST_EXIT_CODE # Exit with the error code from the test script
else
