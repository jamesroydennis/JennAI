        ...
        try:
            ...
            try:
                if selection in ["flask", "angular", "react"]:
                    ...
                    run_command(f'{PY_EXEC} -m pytest src/business/tests src/data/tests tests src/presentation/tests --alluredir="{str(PROJECT_ROOT / "allure-results")}" --clean-alluredir')
