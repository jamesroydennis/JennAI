...
# Global configuration settings for the PyRepo-Pal project.
...
# This can be overridden by an environment variable (e.g., PYREPOPAL_ENVIRONMENT)
# for deployment flexibility. Defaults to "DEV" if not set.
ENVIRONMENT = os.getenv("PYREPOPAL_ENVIRONMENT", "DEV").upper()
