...
from src.core.dependency_container import DependencyContainer # Corrected import path for core
from src.presentation.api_server.flask_app.routes.default_routes import default_bp
from image_processing_api import image_processing_bp # Import from project root
